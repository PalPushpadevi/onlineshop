                    ...
                    <div class="col-md-12">
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="item">
                                    <img class="slide-image" src="${images}/newkids.jpg">
                                </div>
                                <div class="item">
                                     <img class="slide-image" src="${images}/newkids1.jpg" style="max-height:600px">
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <h4 class="pull-right">Rs.500.</h4>
                                <h4><a href="${contextRoot}/show/category/3/products" > <img src="${images}/im1.jpg" alt=""></a>
                                </h4>
                            <div class="ratings">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                                ...
                                <h4 class="pull-right">Rs.700</h4>
                                 <h4><a href="${contextRoot}/show/category/3/products" > <img src="${images}/im3.jpg" alt=""></a>
                                </h4>
